...
namespace TheSocialMedia.WebApp.Controllers
{
    ...
    public class ProfilesController : Controller
    {
        ...
        public ProfilesController(TheSocialMediaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhotoUrl")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,PhotoUrl")] Profile profile)
        {
            if (id != profile.Id)
            {
                return NotFound();
